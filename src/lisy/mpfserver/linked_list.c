...
/* Given a reference (pointer to pointer) to the head
  ...
  of the list. */
void
push_sound_element(struct Node_sound_element** head_ref, char* new_filename_with_path, Mix_Music* new_music) {
    /* allocate node */
    struct Node_sound_element* new_node = (struct Node_sound_element*)malloc(sizeof(struct Node_sound_element));
...
Mix_Music*
search_sound_element(struct Node_sound_element* head, char* filename_with_path) {
