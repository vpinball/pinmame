...
void parse_cmdline (int argc, char **argv, int game_index, char *override_default_rompath)
{
	...
	/* read palette info */
        options.dmd_red = get_int ("config", "dmd_red",  NULL, 225);
        options.dmd_green = get_int ("config", "dmd_green",  NULL, 224);
        options.dmd_blue = get_int ("config", "dmd_blue",  NULL, 32);
        options.dmd_perc1 = get_int("config","dmd_perc1", NULL, 20);
        options.dmd_perc2 = get_int("config","dmd_perc2", NULL, 34);
        options.dmd_perc3 = get_int("config","dmd_perc3", NULL, 67);
        if(options.dmd_red < 0) options.dmd_red = 0;
        if(options.dmd_red > 255) options.dmd_red = 255;
        if(options.dmd_green < 0) options.dmd_green = 0;
        if(options.dmd_green > 255) options.dmd_green = 255;
        if(options.dmd_blue < 0) options.dmd_blue = 0;
        if(options.dmd_blue > 255) options.dmd_blue = 255;
        if(options.dmd_perc1 < 0) options.dmd_perc1 = 0;
        if(options.dmd_perc1 > 100) options.dmd_perc1 = 100;
        if(options.dmd_perc2 < 0) options.dmd_perc2 = 0;
        if(options.dmd_perc2 > 100) options.dmd_perc2 = 100;
        if(options.dmd_perc3 < 0) options.dmd_red = 0;
        if(options.dmd_perc3 > 100) options.dmd_red = 100;
        }
#endif /* PINMAME_EXT *
