...
static REG_OPTION regGameOpts[] =
{
        ...
        { "dmd_colorize",           RO_BOOL,    &gOpts.dmd_colorize,      0, 0},
        { "dmd_red0",               RO_INT,     &gOpts.dmd_red0,          0, 0},
        { "dmd_green0",             RO_INT,     &gOpts.dmd_green0,        0, 0},
        { "dmd_blue0",              RO_INT,     &gOpts.dmd_blue0,         0, 0},
        { "dmd_red33",              RO_INT,     &gOpts.dmd_red33,         0, 0},
        { "dmd_green33",            RO_INT,     &gOpts.dmd_green33,       0, 0},
        { "dmd_blue33",             RO_INT,     &gOpts.dmd_blue33,        0, 0},
...
BOOL OptionsInit()
{
        ...
        global.dmd_colorize      = FALSE;
        global.dmd_red0          = 0;
        global.dmd_green0        = 0;
        global.dmd_blue0         = 0;
        global.dmd_red33         = 6;
        global.dmd_green33       = 0;
        global.dmd_blue33        = 214;
