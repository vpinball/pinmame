...
//    offset=0xc3;
  ...
  for (ii = 1; ii <= 32; ii++) {
    ...
    for (jj = 0; jj < (128/8); jj++) {
      *line++ = 63 + ((RAM[0]>>7 & 0x01) | (RAM2[0]>>6 & 0x02));
      *line++ = 63 + ((RAM[0]>>6 & 0x01) | (RAM2[0]>>5 & 0x02));
      *line++ = 63 + ((RAM[0]>>5 & 0x01) | (RAM2[0]>>4 & 0x02));
      *line++ = 63 + ((RAM[0]>>4 & 0x01) | (RAM2[0]>>3 & 0x02));
      *line++ = 63 + ((RAM[0]>>3 & 0x01) | (RAM2[0]>>2 & 0x02));
      *line++ = 63 + ((RAM[0]>>2 & 0x01) | (RAM2[0]>>1 & 0x02));
      *line++ = 63 + ((RAM[0]>>1 & 0x01) | (RAM2[0]>>0 & 0x02));
      *line++ = 63 + ((RAM[0]>>0 & 0x01) | (RAM2[0]<<1 & 0x02));
      RAM += 1; RAM2 += 1;
    }
    *line = 0;
  }
...
PINMAME_VIDEO_UPDATE(alvgdmd_update2) {
  ...
  if (dmdlocals.planenable) {
	  ...
	  for (ii = 1; ii <= 32; ii++) {
		UINT8 *line = &dotCol[ii][0];
		for (jj = 0; jj < (128/8); jj++) {
		  *line++ = 63 + ((RAM[0]>>7 & 0x01) | (RAM[0x200]>>6 & 0x02) | (RAM[0x400]>>5 & 0x04) | (RAM[0x600]>>4 & 0x08));
		  *line++ = 63 + ((RAM[0]>>6 & 0x01) | (RAM[0x200]>>5 & 0x02) | (RAM[0x400]>>4 & 0x04) | (RAM[0x600]>>3 & 0x08));
		  *line++ = 63 + ((RAM[0]>>5 & 0x01) | (RAM[0x200]>>4 & 0x02) | (RAM[0x400]>>3 & 0x04) | (RAM[0x600]>>2 & 0x08));
		  *line++ = 63 + ((RAM[0]>>4 & 0x01) | (RAM[0x200]>>3 & 0x02) | (RAM[0x400]>>2 & 0x04) | (RAM[0x600]>>1 & 0x08));
		  *line++ = 63 + ((RAM[0]>>3 & 0x01) | (RAM[0x200]>>2 & 0x02) | (RAM[0x400]>>1 & 0x04) | (RAM[0x600]>>0 & 0x08));
		  *line++ = 63 + ((RAM[0]>>2 & 0x01) | (RAM[0x200]>>1 & 0x02) | (RAM[0x400]>>0 & 0x04) | (RAM[0x600]<<1 & 0x08));
		  *line++ = 63 + ((RAM[0]>>1 & 0x01) | (RAM[0x200]>>0 & 0x02) | (RAM[0x400]<<1 & 0x04) | (RAM[0x600]<<2 & 0x08));
		  *line++ = 63 + ((RAM[0]>>0 & 0x01) | (RAM[0x200]<<1 & 0x02) | (RAM[0x400]<<2 & 0x04) | (RAM[0x600]<<3 & 0x08));
	  ...
	  for (ii = 1; ii <= 32; ii++) {
		UINT8 *line = &dotCol[ii][0];
		for (jj = 0; jj < (128/8); jj++) {
		  *line++ = 63 + ((RAM[0]>>7 & 0x01) | (RAM[0]>>6 & 0x02) | (RAM[0]>>5 & 0x04) | (RAM[0]>>4 & 0x08));
		  *line++ = 63 + ((RAM[0]>>6 & 0x01) | (RAM[0]>>5 & 0x02) | (RAM[0]>>4 & 0x04) | (RAM[0]>>3 & 0x08));
		  *line++ = 63 + ((RAM[0]>>5 & 0x01) | (RAM[0]>>4 & 0x02) | (RAM[0]>>3 & 0x04) | (RAM[0]>>2 & 0x08));
		  *line++ = 63 + ((RAM[0]>>4 & 0x01) | (RAM[0]>>3 & 0x02) | (RAM[0]>>2 & 0x04) | (RAM[0]>>1 & 0x08));
		  *line++ = 63 + ((RAM[0]>>3 & 0x01) | (RAM[0]>>2 & 0x02) | (RAM[0]>>1 & 0x04) | (RAM[0]>>0 & 0x08));
		  *line++ = 63 + ((RAM[0]>>2 & 0x01) | (RAM[0]>>1 & 0x02) | (RAM[0]>>0 & 0x04) | (RAM[0]<<1 & 0x08));
		  *line++ = 63 + ((RAM[0]>>1 & 0x01) | (RAM[0]>>0 & 0x02) | (RAM[0]<<1 & 0x04) | (RAM[0]<<2 & 0x08));
		  *line++ = 63 + ((RAM[0]>>0 & 0x01) | (RAM[0]<<1 & 0x02) | (RAM[0]<<2 & 0x04) | (RAM[0]<<3 & 0x08));
...
PINMAME_VIDEO_UPDATE(alvgdmd_update3) {
  ...
  if (dmdlocals.planenable) {
	  ...
	  for (ii = 1; ii <= 32; ii++) {
		UINT8 *line = &dotCol[ii][0];
		for (jj = 0; jj < (128/8); jj++) {
		  *line++ = 63 + ((RAM[0x600]>>7 & 0x01) | (RAM[0x400]>>6 & 0x02) | (RAM[0x200]>>5 & 0x04) | (RAM[0]>>4 & 0x08));
		  *line++ = 63 + ((RAM[0x600]>>6 & 0x01) | (RAM[0x400]>>5 & 0x02) | (RAM[0x200]>>4 & 0x04) | (RAM[0]>>3 & 0x08));
		  *line++ = 63 + ((RAM[0x600]>>5 & 0x01) | (RAM[0x400]>>4 & 0x02) | (RAM[0x200]>>3 & 0x04) | (RAM[0]>>2 & 0x08));
		  *line++ = 63 + ((RAM[0x600]>>4 & 0x01) | (RAM[0x400]>>3 & 0x02) | (RAM[0x200]>>2 & 0x04) | (RAM[0]>>1 & 0x08));
		  *line++ = 63 + ((RAM[0x600]>>3 & 0x01) | (RAM[0x400]>>2 & 0x02) | (RAM[0x200]>>1 & 0x04) | (RAM[0]>>0 & 0x08));
		  *line++ = 63 + ((RAM[0x600]>>2 & 0x01) | (RAM[0x400]>>1 & 0x02) | (RAM[0x200]>>0 & 0x04) | (RAM[0]<<1 & 0x08));
		  *line++ = 63 + ((RAM[0x600]>>1 & 0x01) | (RAM[0x400]>>0 & 0x02) | (RAM[0x200]<<1 & 0x04) | (RAM[0]<<2 & 0x08));
		  *line++ = 63 + ((RAM[0x600]>>0 & 0x01) | (RAM[0x400]<<1 & 0x02) | (RAM[0x200]<<2 & 0x04) | (RAM[0]<<3 & 0x08));
