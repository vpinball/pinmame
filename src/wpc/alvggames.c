...
/-------------------------------------------------------------------*/
INITGAME(wtgband, DMD, FLIP78, 3/*?*/, SNDBRD_NONE, 5)
ALVGROMSTART(wtgband,	"cpu27c.512", CRC(c9572fb5) SHA1(47a3e8943ef4207011a33f4a03a6e722c937cc48))
ALVG_ROMEND
CORE_GAMEDEFNV(wtgband,"World Tour Garage Band",1992,"Alvin G",mALVG,GAME_NO_SOUND)

#if 0
"soundc.512"   , CRC(b44bee01) SHA1(795d8500e5bd73ce23756bf1f5c96db1a3621a70)
...
"cpu27c.512"   , CRC(c9572fb5) SHA1(47a3e8943ef4207011a33f4a03a6e722c937cc48)
#endif
...
/ Pistol Poker
/-------------------------------------------------------------------*/
INITGAME(pstlpkr, DMD, FLIP78, 3/*?*/, SNDBRD_NONE, 5)
ALVGROMSTART(pstlpkr,	"p_peteu2.512", CRC(490a1e2d) SHA1(907dd858ed948681e7366a64a0e7537ebe301d6b))
ALVG_ROMEND
CORE_GAMEDEFNV(pstlpkr,"Pistol Poker",1993,"Alvin G",mALVG,GAME_NO_SOUND)
...
"p_peteu2.512" , CRC(490a1e2d) SHA1(907dd858ed948681e7366a64a0e7537ebe301d6b)
...
"p_pu102.512"  , CRC(b8fb806e) SHA1(c2dc19820ea22bbcf5808db2fb4be76a4033d6ea)
