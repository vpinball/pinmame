...
/-------------------------------------------------------------------*/
INITGAME(atarians, atari_disp, FLIPSW, 1)
...
/ Time 2000 (06/1977)
/-------------------------------------------------------------------*/
INITGAME(time2000, atari_disp, FLIPSW, 1)
...
/-------------------------------------------------------------------*/
INITGAME(aavenger, atari_disp, FLIPSW, 1)
...
/-------------------------------------------------------------------*/
INITGAME(midearth, atari_disp, FLIPSW, 1)
...
/-------------------------------------------------------------------*/
INITGAME(spcrider, atari_disp, FLIPSW, 1)
...
/ Superman (03/1979)
/-------------------------------------------------------------------*/
INITGAME(superman, atari_disp, FLIPSW, 1)
...
/ Hercules (05/1979)
/-------------------------------------------------------------------*/
INITGAME(hercules, atari_disp, FLIPSW, 1)
