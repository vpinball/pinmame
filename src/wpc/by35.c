...
static const UINT16 nuova_ascii2seg[] = {
  ...
  /* 0x20-0x27 */ 0x0000, 0xffff, 0xffff, 0xffff, 0xffff, 0xee99, 0xffff, 0x0200, //      % '
  /* 0x28-0x2f */ 0x1400, 0x4100, 0xff00, 0xaa00, 0x0018, 0x8800, 0x0010, 0x4400, // ()*+,-./
  /* 0x30-0x37 */ 0x00ff, 0x2200, 0x8877, 0x883f, 0x888c, 0x88bb, 0x88fb, 0x000f, // 01234567
  /* 0x38-0x3f */ 0x88ff, 0x88bf, 0x0810, 0x0818, 0x1400, 0x8830, 0x4100, 0x2807, // 89:;<=>?
