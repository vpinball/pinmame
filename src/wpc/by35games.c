...
BY17_ROMEND
CORE_GAMEDEFNV(freedom,"Freedom",1977,"Bally",by35_mBY17,GAME_NO_SOUND)
/*--------------------------------
/ Night Rider
/-------------------------------*/
...
BY17_ROMEND
CORE_GAMEDEFNV(nightrdr,"Night Rider",1977,"Bally",by35_mBY17,GAME_NO_SOUND)
/*--------------------------------
/ EVEL KNIEVEL
/-------------------------------*/
...
BY17_ROMSTARTx88(evelknie,"722-17_2.716",0xb6d9a3fa,
			  "720-20_6.716",0x0c17aa4d)
BY17_ROMEND
CORE_GAMEDEFNV(evelknie,"Evel Knievel",1977,"Bally",by35_mBY17,GAME_NO_SOUND)
/*--------------------------------
/ Eight Ball
/-------------------------------*/
...
BY17_ROMSTARTx88(eightbll,"723-20_2.716",0x33559e7b,
			  "720-20_6.716",0x0c17aa4d)
BY17_ROMEND
CORE_GAMEDEFNV(eightbll,"Eight Ball",1977,"Bally",by35_mBY17,GAME_NO_SOUND)
/*--------------------------------
/ Power Play
/-------------------------------*/
...
BY17_ROMSTARTx88(pwerplay,"724-25_2.716",0x43012f35,
			  "720-20_6.716",0x0c17aa4d)
BY17_ROMEND
CORE_GAMEDEFNV(pwerplay,"Power Play",1978,"Bally",by35_mBY17,GAME_NO_SOUND)
/*--------------------------------
/ Mata Hari
/-------------------------------*/
...
BY17_ROMSTARTx88(matahari,"725-21_2.716",0x63acd9b0,
			  "720-20_6.716",0x0c17aa4d)
BY17_ROMEND
CORE_GAMEDEFNV(matahari,"Mata Hari",1978,"Bally",by35_mBY17,GAME_NO_SOUND)
/*--------------------------------
/ Strikes and Spares
/-------------------------------*/
...
BY17_ROMSTARTx88(stk_sprs,"740-16_2.716",0x2be27024,
			  "720-20_6.716",0x0c17aa4d)
BY17_ROMEND
CORE_GAMEDEFNV(stk_sprs,"Strikes and Spares",1978,"Bally",by35_mBY17,GAME_NO_SOUND)
/*--------------------------------
/ Black Jack
/-------------------------------*/
...
BY17_ROMSTARTx88(blackjck,"728-32_2.716",0x1333c9d1,
			  "720-20_6.716",0x0c17aa4d)
BY17_ROMEND
CORE_GAMEDEFNV(blackjck,"Black Jack",1978,"Bally",by35_mBY17,GAME_NO_SOUND)
/*--------------------------------
/ Lost World
/-------------------------------*/
...
/ Xenon
/-------------------------------*/
INITGAME(xenon,GEN_BY35_56,dispBy6,FLIP_SW(FLIP_L),8)
...
BY35_ROMEND
CORE_GAMEDEFNV(xenon,"Xenon",1980,"Bally",by35_mBY35_56S,GAME_NOT_WORKING)
/*--------------------------------
/ Flash Gordon
/-------------------------------*/
...
/ Embryon
/-------------------------------*/
INITGAME(embryon ,GEN_BY35_61,dispBy7,FLIP_SW(FLIP_L),0)
BY35_ROMSTARTx00(embryon ,"841-06_2.732", 0x80ab18e7,
			  "720-52_6.732", 0x2a43d9fb)
BY35_SOUND61ROMxx80("841-01_4.716",0xe8b234e3,
                    "841-02_5.532",0x9cd8c04e)
BY35_ROMEND
CORE_GAMEDEFNV(embryon ,"Embryon",1981,"Bally",by35_mBY35_61S,0)
/*--------------------------------
/ Fathom
/-------------------------------*/
INITGAME(fathom  ,GEN_BY35_61,dispBy7,FLIP_SW(FLIP_L),0)
...
BY35_ROMEND
CORE_GAMEDEFNV(fathom  ,"Fathom",1981,"Bally",by35_mBY35_61S,0)
/*--------------------------------
/ Medusa
/-------------------------------*/
INITGAME(medusa  ,GEN_BY35_61,dispBy7,FLIP_SW(FLIP_L),8)
...
BY35_ROMEND
CORE_GAMEDEFNV(medusa  ,"Medusa",1981,"Bally",by35_mBY35_61S,GAME_NOT_WORKING)
/*--------------------------------
/ Centaur
/-------------------------------*/
INITGAME(centaur ,GEN_BY35_81,dispBy7,FLIP_SW(FLIP_L),8)
...
BY35_ROMEND
CORE_GAMEDEFNV(centaur,"Centaur",1981,"Bally",by35_mBY35_81S,GAME_IMPERFECT_SOUND)
/*--------------------------------
/ Elektra
/-------------------------------*/
...
/-------------------------------*/
INITGAME(spectrum,GEN_BY35_61,dispBy7,FLIP_SW(FLIP_L),8)
...
BY35_ROMEND
CORE_GAMEDEFNV(spectrum,"Spectrum",1982,"Bally",by35_mBY35_61S,0)
...
BY35_SOUND61ROMx008("868-01_3.532",0xc3a16c66,
                    ...
                    "868-03_5.716",0x4a5ac3b8)
BY35_ROMEND
CORE_CLONEDEFNV(spectru4,spectrum, "Spectrum 4 Player",1982,"Bally",by35_mBY35_61S,GAME_NOT_WORKING)
/*--------------------------------
/ Speak Easy 2 Player
/-------------------------------*/
...
/*--------------------------------
/ Rapid Fire (2 player? no sound)
/-------------------------------*/
INITGAME(rapidfir,GEN_BY35_61,dispBy7,FLIP_SW(FLIP_L),8)
BY35_ROMSTARTx00(rapidfir,"869-04_2.732", 0x26fdf048,
                          "869-03_6.732", 0xf6af5e8d)
BY35_SOUND61ROMxxx0("869-02_5.532",0x5a74cb86)
BY35_ROMEND
CORE_GAMEDEFNV(rapidfir,"Rapid Fire",1982,"Bally",by35_mBY35_61S,GAME_NO_SOUND)
/*--------------------------------
/ Mr. and Mrs. Pacman
/-------------------------------*/
...
{ 2,16,34,6,CORE_SEG7}, /* credit/ball */
{ 5,15,42,2,CORE_SEG7}, { 5,20,44,2,CORE_SEG7}, { 5,25,46,2,CORE_SEG7},{0}
};
...
BY35_ROMSTARTx00(goldball,"gold2732.u2", 0x3169493c,
	                  "720-5332.u6", 0xc2e92f80)
BY35_ROMEND
CORE_GAMEDEFNV(goldball,"Gold Ball",1983,"Bally",by35_mBY35_51,GAME_NO_SOUND | GAME_NOT_WORKING)
...
BY35_ROMEND
CORE_GAMEDEFNV(stingray,"Stringray",1977,"Stern",by35_mBY17,GAME_NO_SOUND)
...
//BY35_SOUND32ROM("729-51_3.123",0x6e7d3e8b)
BY35_ROMEND
...
//BY35_SOUND32ROM("729-51_3.123",0x6e7d3e8b)
BY35_ROMEND
CORE_GAMEDEFNV(quicksil,"Quicksilver",1980,"Stern",by35_mBY35_50,GAME_NO_SOUND)
...
/ Dragonfist
/-------------------------------*/
INITGAME(dragfist,GEN_STMPU200,dispBy7,FLIP_SW(FLIP_L),0)
...
/ Lightning
/-------------------------------*/
INITGAME(lightnin,GEN_STMPU200,dispBy7,FLIP_SW(FLIP_L),0)
...
/ Orbitor 1
/-------------------------------*/
INITGAME(orbitor1,GEN_STMPU200,dispBy7,FLIP_SW(FLIP_L),0)
...
//BY35_SOUND32ROM("729-51_3.123",0x6e7d3e8b)
BY35_ROMEND
CORE_GAMEDEFNV(cue,"Cue (Proto)",1982,"Stern",by35_mBY35_50,GAME_NO_SOUND)
...
//BY35_SOUND32ROM("729-51_3.123",0x6e7d3e8b)
BY35_ROMEND
CORE_GAMEDEFNV(lazrlord,"Lazer Lord (Proto)",1984,"Stern",by35_mBY35_50,GAME_NO_SOUND)
