...
static void sndcmd2_data_w(int param)
{
//	pia_3_portb_w(3, (param>>1) & 0x0f);
//	pia_3_ca1_w(3, ~param & 0x10);
	pia_set_input_b(3,param & 0x0f);
	//pia_set_input_ca1(3,~param & 0x1);
	pia_set_input_ca1(3, 0);
	pia_set_input_ca1(3, 1);
}
...
WRITE_HANDLER(by6803_sndcmd2) { 
	printf("Sound Command %x\n",data);
	snd_cmd_log(data);
	timer_set(TIME_NOW, data, sndcmd2_data_w); 
}


static void sndcmd3_data_w(int param)
{
	//pia_4_portb_w(4, param & 0x0f);
	//pia_4_ca1_w(4, ~param & 0x10);

	printf("calling cmd3\n");
	pia_set_input_b(4, param & 0x0f);
	//pia_set_input_ca1(4,~param & 0x1);
	pia_set_input_ca1(4, 0);
	pia_set_input_ca1(4, 1);
}
...
WRITE_HANDLER(by6803_sndcmd3) { 
	printf("Sound Command %x\n",data);
	snd_cmd_log(data);
	timer_set(TIME_NOW, data, sndcmd3_data_w);
}
