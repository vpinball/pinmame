...
#define INITGAME(name, gen, disp, balls) \
...
INITGAME(ghv101, 0, cc_dispDMD128x32, 3)
...
/ Pinball Magic (10/95)
/-------------------------------------------------------------------*/
INITGAME(pmv112, 1, cc_dispDMD128x32, 3)
...
INITGAME(pmv112r, 2, cc_dispDMD128x32, 3)
...
/ Airborne (03/96)
/-------------------------------------------------------------------*/
INITGAME(abv106, 3, cc_dispDMD128x32, 3)
...
INITGAME(abv106r, 4, cc_dispDMD128x32, 3)
...
/ Breakshot (05/96)
/-------------------------------------------------------------------*/
INITGAME(bsv103, 5, cc_dispDMD128x32, 3)
...
INITGAME(bsv100r, 6, cc_dispDMD128x32, 3)
...
INITGAME(bsv102r, 7, cc_dispDMD128x32, 3)
...
INITGAME(bsb105, 8, cc_dispDMD128x32, 3)
...
/-------------------------------------------------------------------*/
INITGAME(ffv104, 9, cc_dispDMD256x64, 3)
...
/-------------------------------------------------------------------*/
INITGAME(bbb109, 10, cc_dispDMD128x32, 3)
...
/-------------------------------------------------------------------*/
//
INITGAME(kpv106, 11, cc_dispDMD128x32, 3)
