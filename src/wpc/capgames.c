...
#define INITGAME(name, gameno, disp, balls, lamps) \
	CC_INPUT_PORTS_START(name, balls) CC_INPUT_PORTS_END \
	static core_tGameData name##GameData = {0,disp,{FLIP,0,lamps,0,0,0,gameno}}; \
...
INITGAME(ghv101, 0, cc_dispDMD128x32, 3, 0)
...
/ Pinball Magic (10/95)
/-------------------------------------------------------------------*/
INITGAME(pmv112, 1, cc_dispDMD128x32, 3, 8)
//Version 1.12
...
/-------------------------------------------------------------------*/
//Version 1.06
INITGAME(abv106, 3, cc_dispDMD128x32, 3, 8)
...
/-------------------------------------------------------------------*/
//Version 1.03
INITGAME(bsv103, 5, cc_dispDMD128x32, 3, 0)
...
/-------------------------------------------------------------------*/
//Version 1.04
INITGAME(ffv104, 9, cc_dispDMD256x64, 3, 8)
...
/-------------------------------------------------------------------*/
//Beta Version 1.09
INITGAME(bbb109, 10, cc_dispDMD128x32, 3, 8)
...
/-------------------------------------------------------------------*/
//Beta Version 1.06
INITGAME(kpv106, 11, cc_dispDMD128x32, 3, 8)
