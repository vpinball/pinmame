...
DE_ROMSTART48(tmnt_101,"tmntb5a.101", CRC(42ae083d) SHA1(0dd62dd7e3cd5db1729cec30e1831093bc63ce6e),
                       "tmntc5a.101", CRC(24ba0267) SHA1(8e157faa1ade6a1d9f9b6d395d708cfa521597b3))
DE_DMD16ROM1(          "tmntdspa.103",CRC(d52a7d49) SHA1(9249aafe272a052d19f1dd461708e8152516f79f))
...
DE_ROMSTARTx0(rab_110be,"Rocky-Bull_1.10_Belgium-C5.bin",CRC(195BC8E4) SHA1(bfcb8f0881a0638d4502f4df332629c401ee905e)) // unknown so far if there are special 1.10 CPU roms for each language (rom was labelled as 'B1.10' though, and reports as belgian)
...
DE_DMD32ROM8x(         "jpdspa.400",CRC(4c044f05) SHA1(573a188a255ad3b6aa18427fd6b45aeca6f83e04)) // Not dumped on this set, using 4.00 from the 3.07 revision
DE2S_SOUNDROM142(      "jpu7.dat"  ,CRC(f3afcf13) SHA1(64e12f9d42c00ae08a4584b2ebea475566b90c13),
                       "jpu17.dat" ,CRC(38135a23) SHA1(7c284c17783269824a3d3e83c4cd8ead27133309),
                       "jpu21.dat" ,CRC(6ac1554c) SHA1(9a91ce836c089f96ad9c809bb66fcddda1f3e456))
DE_ROMEND
...
DE_ROMSTARTx0(jupk_307,"jpcpua.307",CRC(b60c3bca) SHA1(0f5619319d2affefa993f396f7a4b1875eea81ab))
DE_DMD32ROM8x(         "jpdspa.400",CRC(4c044f05) SHA1(573a188a255ad3b6aa18427fd6b45aeca6f83e04))
DE2S_SOUNDROM142(      "jpu7.dat"  ,CRC(f3afcf13) SHA1(64e12f9d42c00ae08a4584b2ebea475566b90c13),
                       "jpu17.dat" ,CRC(38135a23) SHA1(7c284c17783269824a3d3e83c4cd8ead27133309),
                       "jpu21.dat" ,CRC(6ac1554c) SHA1(9a91ce836c089f96ad9c809bb66fcddda1f3e456))
DE_ROMEND
CORE_CLONEDEF(jupk,307,513,"Jurassic Park (3.07)",1993,"Data East",de_mDEDMD32S2A,0)
...
DE_ROMSTARTx0(lah_107,"lahcpua.107",CRC(f777fc1b) SHA1(a1a645df907e1e88123113823d3edf12c4e1e5df))
DE_DMD32ROM8x(      "lahdispa.104",CRC(baf4e7b3) SHA1(78924d992c0e206bfbf4a6fcc62ea7f91e995260))
DE2S_SOUNDROM142(   "lahsnd.u7"  ,CRC(0279c45b) SHA1(14daf6b711d1936352209e90240f51812ebe76e0),
                    "lahsnd.u17" ,CRC(d0c15fa6) SHA1(5dcd13b578fa53c82353cda5aa774ca216c5ddfe),
                    "lahsnd.u21" ,CRC(4571dc2e) SHA1(a1068cb080c30dbc07d164eddfc5dfd0afd52d3b))
...
DE_ROMSTARTx0(tomy_201d,"Tommy_2.01_Dutch_cpu.bin", CRC(9705af61) SHA1(8a302d2f217d0f10bf100606643fc1780564da67))
DE_DMD32ROM8x(      "Tommy_2.00_display.bin",CRC(e554e0dc) SHA1(2b3baf20280134e3a40c41e0e0c39578dd905abe))
DE2S_SOUNDROM14444( "tommysnd.u7" ,CRC(ab0b4626) SHA1(31237b4f5e866710506f1336e3ca2dbd6a89385a),
                    "tommysnd.u17",CRC(11bb2aa7) SHA1(57b4867c109996861f45ead1ceedb7153aff852e),
                    "tommysnd.u21",CRC(bb4aeec3) SHA1(2ac6cd25b79584fa6ad2c8a36c3cc58ab8ec0206),
                    "tommysnd.u36",CRC(208d7aeb) SHA1(af8af2094d1a91c7b4ef8ac6d4f594728e97450f),
                    "tommysnd.u37",CRC(46180085) SHA1(f761c27532180de313f23b41f02341783be8938b))
DE_ROMEND
CORE_CLONEDEF(tomy,201d,400,"Tommy Pinball Wizard, The Who's (2.01 Dutch)",1994,"Data East",de_mDEDMD32S2A,0)
...
DE_ROMSTARTx0(bay_e400, "baycpue.400", CRC(07b77fe2) SHA1(4f81a5b3d821907e06d6b547117ad39c238a900c))
DE_DMD64ROM88(          "bayrom0a.400",CRC(43d615c6) SHA1(7c843b6d5215305b02a55c9fa1d62375ef0766ea),
                        "bayrom3a.400",CRC(41bcb66b) SHA1(e6f0a9236e14c2e919881ca1ffe3356aaa121730))
...
DE_DMD64ROM88(          "bayrom0a.300",CRC(3f195829) SHA1(a10a1b7f125f239b0eff87ee6667c8250b7ffc87),
                        "bayrom3a.300",CRC(ae3d8585) SHA1(28b38ebc2755ffb3859f8091a9bf50d868794a3e))
DE2S_SOUNDROM144(       "bayw.u7"  ,   CRC(90d6d8a8) SHA1(482c5643453f21a078257aa13398845ef19cab3c),
                        "bayw.u17" ,   CRC(b20fde56) SHA1(2f2db49245e4a6a8251cbe896b2437fcec88d42d),
                        "bayw.u21" ,   CRC(b7598881) SHA1(19d1dde1cb6634a7c7b5cdb4fa01cd09cc7d7777))
DE_ROMEND
...
#define init_bay_g300 init_baywatch
DE_ROMSTARTx0(bay_g300, "Baywatch_CPUG_C5_3.00.BIN", CRC(8f85fd10) SHA1(1fd561bf6145caf15846a776b0b92e7953fdf3ff))
DE_DMD64ROM88(          "Baywatch_DispG_ROM0_3.00.BIN", CRC(30b0a96a) SHA1(ff0e4d4a1726ff2a553ebe4f21c0534e0a06b960),
                        "Baywatch_DispG_ROM3_3.00.BIN", CRC(c7e50fad) SHA1(95b60855cb6718eb9c8a7231e9cd2e1c326cd1e3))
DE2S_SOUNDROM144(       "bayw.u7"  ,   CRC(90d6d8a8) SHA1(482c5643453f21a078257aa13398845ef19cab3c),
                        "bayw.u17" ,   CRC(b20fde56) SHA1(2f2db49245e4a6a8251cbe896b2437fcec88d42d),
                        "bayw.u21" ,   CRC(b7598881) SHA1(19d1dde1cb6634a7c7b5cdb4fa01cd09cc7d7777))
DE_ROMEND
#define input_ports_bay_g300 input_ports_baywatch
CORE_CLONEDEFNV(bay_g300,baywatch,"Baywatch (3.00 German)",1995,"Sega",de_mDEDMD64S2A,0)

#define init_bay_f201 init_baywatch
DE_ROMSTARTx0(bay_f201, "baycpuf.201", CRC(d2fddeaa) SHA1(839baca46823dc72a7ef1421764815f69f0e7084))
DE_DMD64ROM88(          "bayrom0f.200",CRC(6dc898b6) SHA1(087b043acf64b2a16c8e4c879b90dbea1d79c614),
                        "bayrom3f.200",CRC(9db1b94e) SHA1(056c1a0fd1c99c1c9426f2e2cdd68f4bbaa89d81))
DE2S_SOUNDROM144(       "bayw.u7"  ,   CRC(90d6d8a8) SHA1(482c5643453f21a078257aa13398845ef19cab3c),
                        "bayw.u17" ,   CRC(b20fde56) SHA1(2f2db49245e4a6a8251cbe896b2437fcec88d42d),
                        "bayw.u21" ,   CRC(b7598881) SHA1(19d1dde1cb6634a7c7b5cdb4fa01cd09cc7d7777))
DE_ROMEND
#define input_ports_bay_f201 input_ports_baywatch
CORE_CLONEDEFNV(bay_f201,baywatch,"Baywatch (2.01 French)",1995,"Sega",de_mDEDMD64S2A,0)
