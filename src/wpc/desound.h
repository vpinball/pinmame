...
#define DE3S_SOUNDROM18888(u7,chk7, u17,chk17,u21,chk21,u36,chk36,u37,chk37) \
  SOUNDREGION(0x010000, DE2S_CPUREGION) \
    ROM_LOAD(u7,0x0000,0x10000,chk7) \
  SOUNDREGION(0x800000, DE2S_ROMREGION) \
    ROM_LOAD(u17,0x000000,0x100000,chk17) \
      ROM_RELOAD(0x100000,0x100000) \
    ROM_LOAD(u21,0x200000,0x100000,chk21) \
      ROM_RELOAD(0x300000,0x100000) \
    ROM_LOAD(u36,0x400000,0x100000,chk36) \
      ROM_RELOAD(0x500000,0x100000) \
    ROM_LOAD(u37,0x600000,0x100000,chk37) \
      ROM_RELOAD(0x700000,0x100000)

/* 1 X 512Kb(64K) CPU ROM & 1 x 16Mb (2048K) SOUNDS ROM @ U17 & 3 X 8Mb(1024K) SOUNDS ROM @ U21, U36, U37 */
#define DE3S_SOUNDROM10888(u7,chk7, u17,chk17,u21,chk21,u36,chk36,u37,chk37) \
  SOUNDREGION(0x010000, DE2S_CPUREGION) \
    ROM_LOAD(u7,0x0000,0x10000,chk7) \
  SOUNDREGION(0x800000, DE2S_ROMREGION) \
    ROM_LOAD(u17,0x000000,0x200000,chk17) \
    ROM_LOAD(u21,0x200000,0x100000,chk21) \
      ROM_RELOAD(0x300000,0x100000) \
    ROM_LOAD(u36,0x400000,0x100000,chk36) \
      ROM_RELOAD(0x500000,0x100000) \
...
/* 1 X 512Kb(64K) CPU ROM & 1 x 16Mb (2048K) SOUNDS ROM @ U21 & 3 X 8Mb(1024K) SOUNDS ROM @ U17, U36, U37 */
#define DE3S_SOUNDROM18088(u7,chk7, u17,chk17,u21,chk21,u36,chk36,u37,chk37) \
  SOUNDREGION(0x010000, DE2S_CPUREGION) \
    ROM_LOAD(u7,0x0000,0x10000,chk7) \
  SOUNDREGION(0x800000, DE2S_ROMREGION) \
    ROM_LOAD(u17,0x000000,0x100000,chk17) \
      ROM_RELOAD(0x100000,0x100000) \
    ROM_LOAD(u21,0x200000,0x200000,chk21) \
    ROM_LOAD(u36,0x400000,0x100000,chk36) \
      ROM_RELOAD(0x500000,0x100000) \
    ROM_LOAD(u37,0x600000,0x100000,chk37) \
      ROM_RELOAD(0x700000,0x100000)

/* 1 X 512Kb(64K) CPU ROM & 2 x 16Mb (2048K) SOUNDS ROM @ U17, U21 @ 2 X 8Mb(1024K) SOUNDS ROM @ U36, U37 */
#define DE3S_SOUNDROM10088(u7,chk7, u17,chk17,u21,chk21,u36,chk36,u37,chk37) \
  SOUNDREGION(0x010000, DE2S_CPUREGION) \
    ROM_LOAD(u7,0x0000,0x10000,chk7) \
  SOUNDREGION(0x800000, DE2S_ROMREGION) \
    ROM_LOAD(u17,0x000000,0x200000,chk17) \
