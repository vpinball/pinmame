...
DRIVER(lw3,300)         //Data East MPU: 08/20 Lethal Weapon (3.00 unofficial MOD)
DRIVER(lw3,301)         //Data East MPU: 09/20 Lethal Weapon (3.01 unofficial MOD)
...
DRIVER(lah,107)         //Data East MPU: 09/93 Last Action Hero (1.07)
...
DRIVER(tomy,h30)        //Data East MPU: 02/94 The Who's Tommy Pinball Wizard (3.00 Dutch)
DRIVER(tomy,400)        //Data East MPU: 02/94 The Who's Tommy Pinball Wizard (4.00)
DRIVER(tomy,500)        //Data East MPU: 05/16 The Who's Tommy Pinball Wizard (5.00 unofficial MOD)
...
DRIVERNV(seawitchc)     //MPU-200: 11/21 Seawitch (MOD rev. 7)
DRIVERNV(seawitchd)     //MPU-200: 11/21 Seawitch (MOD rev. 8)
...
DRIVER(nf,08x)          //WPC-525:  04/95 W No Fear: Dangerous Sports (0.8 Export)
DRIVER(nf,10)           //          05/95 W No Fear: Dangerous Sports (1.0)
