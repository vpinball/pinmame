...
#define INIT_S1(name, snd) \
GTS1_INPUT_PORTS_START(name, 1) GTS1_INPUT_PORTS_END \
static core_tGameData name##GameData = {0,sys1_disp,{FLIP_SW(FLIP_L),0,2,0,snd}}; \
...
/ Buck Rogers (01/1980)
/-------------------------------------------------------------------*/
INIT_S1(buckrgrs, SNDBRD_GTS80S)
...
/-------------------------------------------------------------------*/
INIT_S1(roldisco, SNDBRD_GTS80S)
...
/-------------------------------------------------------------------*/
INIT_S1(astannie, SNDBRD_GTS80S)
