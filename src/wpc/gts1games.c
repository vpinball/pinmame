...
#define INIT_S1(name, snd, dsp) \
GTS1_INPUT_PORTS_START(name, 1) GTS1_INPUT_PORTS_END \
static core_tGameData name##GameData = {0,dsp,{FLIP_SW(FLIP_L),0,0,0,snd}}; \
...
/ Sinbad (05/1978)
/-------------------------------------------------------------------*/
INIT_S1(sinbad, SNDBRD_NONE, sys1_disp)
...
/ Sinbad (Norway)
/-------------------------------------------------------------------*/
INIT_S1(sinbadn, SNDBRD_NONE, sys1_disp)
...
/ Joker Poker (08/1978)
/-------------------------------------------------------------------*/
INIT_S1(jokrpokr, SNDBRD_NONE, sys1_disp)
...
/ Dragon (10/1978)
/-------------------------------------------------------------------*/
INIT_S1(dragon, SNDBRD_NONE, sys1_disp)
...
/-------------------------------------------------------------------*/
INIT_S1(closeenc, SNDBRD_NONE, sys1_disp)
...
/-------------------------------------------------------------------*/
INIT_S1(charlies, SNDBRD_NONE, sys1_disp)
...
/ Solar Ride (02/1979)
/-------------------------------------------------------------------*/
INIT_S1(solaride, SNDBRD_NONE, sys1_disp)
...
/ Count-Down (05/1979)
/-------------------------------------------------------------------*/
INIT_S1(countdwn, SNDBRD_NONE, sys1_disp)
...
/-------------------------------------------------------------------*/
INIT_S1(pinpool, SNDBRD_NONE, sys1_disp)
...
/ Totem (10/1979)
/-------------------------------------------------------------------*/
INIT_S1(totem, SNDBRD_GTS80S, sys1_disp)
...
/-------------------------------------------------------------------*/
INIT_S1(hulk, SNDBRD_GTS80S, sys1_disp)
...
/ Genie (11/1979)
/-------------------------------------------------------------------*/
INIT_S1(genie, SNDBRD_GTS80S, sys1_disp)
...
/ Buck Rogers (01/1980)
/-------------------------------------------------------------------*/
INIT_S1(buckrgrs, SNDBRD_GTS80S, sys1_disp)
...
/ Torch (02/1980)
/-------------------------------------------------------------------*/
INIT_S1(torch, SNDBRD_GTS80S, sys1_disp)
...
/-------------------------------------------------------------------*/
INIT_S1(roldisco, SNDBRD_GTS80S, sys1_disp)
...
/ System 1 Test prom
/-------------------------------------------------------------------*/
INIT_S1(sys1test, SNDBRD_NONE, sys1_disp)
