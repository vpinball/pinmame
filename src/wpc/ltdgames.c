...
LTD_2_ROMSTART(marqueen, "mqueen.bin", NO_DUMP) //!! gaston made a patched version himself from a broken one
LTD_ROMEND
...
LTD_2_ROMSTART(spcpoker, "spoker.bin", NO_DUMP) //!! gaston made a patched version himself from a broken one
LTD_ROMEND
...
LTD_44_ROMSTART(tmacltd4, "tm4_l.bin", NO_DUMP, //!! gaston made a patched version himself from a broken one (still bad CRC though)
