...
static core_tLCDLayout disp2p5[] = {
  { 1, 0,14,2,CORE_SEG7 }, { 1, 4,18,2,CORE_SEG7 }, { 1, 8,10,1,CORE_SEG7 },
  { 1,16,12,2,CORE_SEG7 }, { 1,20,16,2,CORE_SEG7 }, { 1,24,11,1,CORE_SEG7 },
...
LTD_2_ROMSTART(marqueen, "mqueen.bin", CRC(cb664001) SHA1(00152f89e58bc11567a8de32ccaaa47146dace0d) BAD_DUMP) //!! gaston made a patched version himself from a broken one
LTD_ROMEND
...
static core_tLCDLayout disp2p6[] = {
  ...
  { 1,18, 8,2,CORE_SEG7 }, { 1,22,12,2,CORE_SEG7 }, { 1,26,16,2,CORE_SEG7 },
  { 0,14, 3,1,CORE_SEG7 }, { 2,14, 2,1,CORE_SEG7 },
  {0}
};
...
LTD_2_ROMSTART(spcpoker, "spoker.bin", CRC(3cf29406) SHA1(5c27bda1193077a7b99c5b2dd19adb4d917ba37d) BAD_DUMP) //!! gaston made a patched version himself from a broken one
LTD_ROMEND
...
/ Cowboy Eight Ball
/-------------------------------------------------------------------*/
INITGAME(cowboy3p, disp3p6, 1, 6, 0)
...
INITGAME(zephya, disp3p6, 2, 6, 0)
LTD_4_ROMSTART(zephya, "zephy1.bin", CRC(ae189c8a) SHA1(c309b436ef94cd5c266c88fe5f222261e083e4eb))
LTD_ROMEND
CORE_CLONEDEFNV(zephya,zephy,"Zephy (alternate set)",1982,"LTD",gl_mLTD,GAME_NO_SOUND)
...
LTD_44_ROMSTART(tmacltd4, "tm4_l.bin", CRC(c5c4cd0e) SHA1(307aa7dd8e22bae1e01b10c5da9726271ed8b71b) BAD_DUMP, //!! gaston made a patched version himself from a broken one (still bad CRC though)
