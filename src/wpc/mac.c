...
ROM_START(spcpnthr)
  ...
  NORMALREGION(0x10000, REGION_USER1)
    ROM_LOAD("sp_sound.bin", 0x0000, 0x8000, CRC(d7aedbac) SHA1(4b59028e08b2d7ff8f19596022ba6e830cf736e2))
ROM_END
...
ROM_START(mac_1808)
  ...
  NORMALREGION(0x10000, REGION_USER1)
    ROM_LOAD("mac_1808.snd", 0x0000, 0x8000, CRC(d7aedbac) SHA1(4b59028e08b2d7ff8f19596022ba6e830cf736e2))
ROM_END
...
ROM_START(nbamac)
  ...
  NORMALREGION(0x10000, REGION_USER1)
    ROM_LOAD("nba_mac.snd", 0x0000, 0x8000, CRC(d7aedbac) SHA1(4b59028e08b2d7ff8f19596022ba6e830cf736e2))
ROM_END
