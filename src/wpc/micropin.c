...
DISCRETE_SOUND_START(mp_discInt)
	...
	DISCRETE_SAWTOOTHWAVE(NODE_21,NODE_01,387, 50000,2500,0,0) // G4 note
	DISCRETE_SAWTOOTHWAVE(NODE_22,NODE_02,435, 50000,2500,0,0) // A4 note
	DISCRETE_SAWTOOTHWAVE(NODE_23,NODE_03,488, 50000,2500,0,0) // B4 note
	DISCRETE_SAWTOOTHWAVE(NODE_24,NODE_04,517, 50000,2500,0,0) // C5 note
	DISCRETE_SAWTOOTHWAVE(NODE_25,NODE_05,581, 50000,2500,0,0) // D5 note
	DISCRETE_SAWTOOTHWAVE(NODE_26,NODE_06,652, 50000,2500,0,0) // E5 note
	DISCRETE_SAWTOOTHWAVE(NODE_27,NODE_07,691, 50000,2500,0,0) // F5 note
	DISCRETE_SAWTOOTHWAVE(NODE_28,NODE_08,775, 50000,2500,0,0) // G5 note
	DISCRETE_SAWTOOTHWAVE(NODE_29,NODE_09,870, 50000,2500,0,0) // A5 note
	DISCRETE_SAWTOOTHWAVE(NODE_30,NODE_10,977, 50000,2500,0,0) // B5 note
	DISCRETE_SAWTOOTHWAVE(NODE_31,NODE_11,1035,50000,2500,0,0) // C6 note
	DISCRETE_SAWTOOTHWAVE(NODE_32,NODE_12,1161,50000,2500,0,0) // D6 note
	DISCRETE_SAWTOOTHWAVE(NODE_33,NODE_13,1304,50000,2500,0,0) // E6 note
	DISCRETE_SAWTOOTHWAVE(NODE_34,NODE_14,1381,50000,2500,0,0) // F6 note
	DISCRETE_SAWTOOTHWAVE(NODE_35,NODE_15,1550,50000,2500,0,0) // G6 note
	DISCRETE_SAWTOOTHWAVE(NODE_36,NODE_16,1740,50000,2500,0,0) // A6 note
