...
MIDWAY_1_ROMSTART(flicker,"flicker.rom", CRC(c692e586))
MIDWAY_ROMEND
...
MIDWAY_3_ROMSTART(rotation,	"rot-a117.dat",	CRC(7bb6beb3),
							"rot-b117.dat",	CRC(538e37b2),
							"rot-c117.dat",	CRC(3321ff08))
MIDWAY_ROMEND
