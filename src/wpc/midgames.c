...
#define INITGAME(name, disptype, flippers, balls) \
	...
	static core_tGameData name##GameData = {0,disptype,{flippers,0,-1}}; \
...
core_tLCDLayout flicker_disp[] = {
  {0, 0, 0, 5,CORE_SEG7}, {0,14, 5, 5,CORE_SEG7},
  {4, 3,10, 2,CORE_SEG7}, {4,17,12, 2,CORE_SEG7},
  {0}
};
INITGAME(flicker, flicker_disp, FLIP_SW(FLIP_L), 1)
...
INITGAME(rotation, rot_disp, FLIP_SW(FLIP_L), 1)
