...
/-------------------------------*/
INITGAMENB(suprbowl,GEN_BY35,dispNB,FLIP_SW(FLIP_L),0,SNDBRD_BY61B,BY35GD_NOSOUNDE)
...
/-------------------------------*/
INITGAMENB(sprbwlfp,GEN_BY35,dispNB,FLIP_SW(FLIP_L),0,SNDBRD_BY61B,BY35GD_NOSOUNDE)
