...
#define PEYPER_COMPORTS \
  ...
  PORT_START /* 1 */ \
    COREPORT_DIPNAME( 0x8000, 0x8000, "B-1") \
      COREPORT_DIPSET(0x0000, "1" ) \
      COREPORT_DIPSET(0x8000, "0" ) \
    COREPORT_DIPNAME( 0x4000, 0x0000, "B-2") \
      COREPORT_DIPSET(0x0000, "1" ) \
      COREPORT_DIPSET(0x4000, "0" ) \
    COREPORT_DIPNAME( 0x2000, 0x0000, "B-3") \
      COREPORT_DIPSET(0x0000, "1" ) \
      COREPORT_DIPSET(0x2000, "0" ) \
    COREPORT_DIPNAME( 0x1000, 0x0000, "B-4") \
      COREPORT_DIPSET(0x0000, "1" ) \
      COREPORT_DIPSET(0x1000, "0" ) \
    COREPORT_DIPNAME( 0x0800, 0x0800, "B-5") \
      COREPORT_DIPSET(0x0000, "1" ) \
      COREPORT_DIPSET(0x0800, "0" ) \
    COREPORT_DIPNAME( 0x0400, 0x0400, "B-6") \
      COREPORT_DIPSET(0x0000, "1" ) \
      COREPORT_DIPSET(0x0400, "0" ) \
    COREPORT_DIPNAME( 0x0200, 0x0200, "B-7") \
      COREPORT_DIPSET(0x0000, "1" ) \
      COREPORT_DIPSET(0x0200, "0" ) \
    COREPORT_DIPNAME( 0x0100, 0x0100, "B-8") \
      COREPORT_DIPSET(0x0000, "1" ) \
      COREPORT_DIPSET(0x0100, "0" ) \
    COREPORT_DIPNAME( 0x0080, 0x0000, "A-1") \
      COREPORT_DIPSET(0x0000, "1" ) \
      COREPORT_DIPSET(0x0080, "0" ) \
    COREPORT_DIPNAME( 0x0040, 0x0000, "A-2") \
      COREPORT_DIPSET(0x0000, "1" ) \
      COREPORT_DIPSET(0x0040, "0" ) \
    COREPORT_DIPNAME( 0x0020, 0x0000, "A-3") \
      COREPORT_DIPSET(0x0000, "1" ) \
      COREPORT_DIPSET(0x0020, "0" ) \
    COREPORT_DIPNAME( 0x0010, 0x0000, "A-4") \
      COREPORT_DIPSET(0x0000, "1" ) \
      COREPORT_DIPSET(0x0010, "0" ) \
    COREPORT_DIPNAME( 0x0008, 0x0000, "A-5") \
      COREPORT_DIPSET(0x0000, "1" ) \
      COREPORT_DIPSET(0x0008, "0" ) \
    COREPORT_DIPNAME( 0x0004, 0x0000, "A-6") \
      COREPORT_DIPSET(0x0000, "1" ) \
      COREPORT_DIPSET(0x0004, "0" ) \
    COREPORT_DIPNAME( 0x0002, 0x0000, "A-7") \
      COREPORT_DIPSET(0x0000, "1" ) \
      COREPORT_DIPSET(0x0002, "0" ) \
    COREPORT_DIPNAME( 0x0001, 0x0000, "A-8") \
      COREPORT_DIPSET(0x0000, "1" ) \
