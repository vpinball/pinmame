...
/ 03/82 Cerberus
/-------------------------------------------------------------------*/
INITGAME(cerberus, play_disp6, 1)
...
PLAYMATIC_ROMSTART64(rock2500,"r2500cpu.rom", CRC(d53b0d31) SHA1(83489433b714c3517f5dc1c995743b24049dd623))
PLAYMATIC_SOUNDROM64("r2500snd.rom", NO_DUMP)
PLAYMATIC_ROMEND
