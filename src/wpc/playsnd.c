...
//#define PLAY_OLD_TMS_HACK // seems like not needed anymore since the 09/2026 update of the TMS core?
...
static DISCRETE_SOUND_START(play_tones)
	...
	/* TODO: needs a DISCRETE_CRFILTER before the output - the node below is unipolar,
	   four triangles with BIAS 10000 summed, so roughly +40000 of DC, which then
