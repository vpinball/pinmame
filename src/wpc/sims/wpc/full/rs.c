...
WPC_ROMSTART(rs,l6c,"Road Show U6 game ROM rev L-6 patch ccd1.rom",0x80000,CRC(d5b83269) SHA1(1b413100005efd63cb0344ff921e5d544abed6e4))
RS_SOUND_L1
WPC_ROMEND
...
// Note that PA2 uses a different U2 sound ROM.
