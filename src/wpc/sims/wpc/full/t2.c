...
WPC_ROMSTART(t2,l2sp1,"u6-l2.rom",0x40000,CRC(efe49c18) SHA1(9f91081c384990eac6e3c57f318a2639626929f9)) // there is no prototype game ROM known yet (and P-2 is actually closest to L-6)
WPCS_SOUNDROM222("U18SND_P", CRC(4e6987e2) SHA1(5384b221f8d80bb1138c7c3549baa88aec9f1f93),              // also no "f*ck you a**hole" speech bit at sound command 7a3f, so no profanity in the dump
                 "t2_u15.l3",CRC(dad03ad1) SHA1(7c200f9a6564d751e5aa9b1ba84363b221502770), // the U15SND_P from ipdb reports checksum error, and only one byte difference to L-3
...
WPC_ROMSTART(t2,f20,"ft20_20.rom",0x80000,CRC(27784c3a) SHA1(d4486d89d4376a6145ccb4e4a4689e86e1a2c872))
WPCS_SOUNDROM222("t2_u18.l3",CRC(2280bdd0) SHA1(ea94265cb8291ee427e0a2119d901ba1eb50d8ee),
                 "t2_u15.l3",CRC(dad03ad1) SHA1(7c200f9a6564d751e5aa9b1ba84363b221502770),
                 "t2_u14.l3",CRC(9addc9dc) SHA1(847bb027f6b9167cbbaa13f1af50d61e0c69f01f))
WPC_ROMEND
...
CORE_CLONEDEF(t2,l2,l8,"Terminator 2: Judgment Day (L-2, L-3 Sound)",1991,"Williams",wpc_mDMDS,0)
CORE_CLONEDEF(t2,d2,l8,"Terminator 2: Judgment Day (D-2 LED Ghost Fix)",1991,"Williams",wpc_mDMDS,0)
CORE_CLONEDEF(t2,l2sp1,l8,"Terminator 2: Judgment Day (L-2, P-1 Sound)",1991,"Williams",wpc_mDMDS,0) // didn't notice any differences in speech or sound FX with P-1, so it's not a big change for sure
