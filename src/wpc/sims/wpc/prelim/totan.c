...
CORE_CLONEDEF(totan,15c,14,"Tales of the Arabian Nights (1.5C Competition MOD)",2016,"Williams",wpc_m95S,0)
...
CORE_CLONEDEF(totan,04,14,"Tales of the Arabian Nights (0.4 Prototype)",1996,"Williams",wpc_m95S,0)
