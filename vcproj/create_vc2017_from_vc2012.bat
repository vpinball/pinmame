...
@cscript "simplereplace.wsf" //nologo /replacequotes /search:"</Project>" /replace:"  <Import Project=^'asmjit.props^' /></Project>" /in:"LibPinMAME_VC2017.vcxproj" /out:"LibPinMAME_VC2017.vcxproj"
@if errorlevel 1 goto manual
@cscript "simplereplace.wsf" //nologo /replacequotes /search:"</Project>" /replace:"  <Import Project=^'asmjit.props^' /></Project>" /in:"PinMAME_VC2017.vcxproj" /out:"PinMAME_VC2017.vcxproj"
@if errorlevel 1 goto manual
@cscript "simplereplace.wsf" //nologo /replacequotes /search:"</Project>" /replace:"  <Import Project=^'asmjit.props^' /></Project>" /in:"PinMAME32_VC2017.vcxproj" /out:"PinMAME32_VC2017.vcxproj"
@if errorlevel 1 goto manual
@cscript "simplereplace.wsf" //nologo /replacequotes /search:"</Project>" /replace:"  <Import Project=^'asmjit.props^' /></Project>" /in:"VPinMAME_VC2017.vcxproj" /out:"VPinMAME_VC2017.vcxproj"
@if errorlevel 1 goto manual

@rem --- define PINMAME_JIT_ASMJIT project-wide so the C sources (arm7core.c) see the asmjit hooks
@cscript "simplereplace.wsf" //nologo /search:"<PreprocessorDefinitions>" /replace:"<PreprocessorDefinitions>PINMAME_JIT_ASMJIT;" /in:"LibPinMAME_VC2017.vcxproj" /out:"LibPinMAME_VC2017.vcxproj"
@if errorlevel 1 goto manual
@cscript "simplereplace.wsf" //nologo /search:"<PreprocessorDefinitions>" /replace:"<PreprocessorDefinitions>PINMAME_JIT_ASMJIT;" /in:"PinMAME_VC2017.vcxproj" /out:"PinMAME_VC2017.vcxproj"
@if errorlevel 1 goto manual
@cscript "simplereplace.wsf" //nologo /search:"<PreprocessorDefinitions>" /replace:"<PreprocessorDefinitions>PINMAME_JIT_ASMJIT;" /in:"PinMAME32_VC2017.vcxproj" /out:"PinMAME32_VC2017.vcxproj"
@if errorlevel 1 goto manual
