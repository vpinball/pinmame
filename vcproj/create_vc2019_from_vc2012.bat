...
@cscript "simplereplace.wsf" //nologo /replacequotes /search:"</Project>" /replace:"  <Import Project=^'p2k.props^' /></Project>" /in:"LibPinMAME_VC2019.vcxproj" /out:"LibPinMAME_VC2019.vcxproj"
@if errorlevel 1 goto manual
@cscript "simplereplace.wsf" //nologo /replacequotes /search:"</Project>" /replace:"  <Import Project=^'p2k.props^' /></Project>" /in:"PinMAME_VC2019.vcxproj" /out:"PinMAME_VC2019.vcxproj"
@if errorlevel 1 goto manual
@cscript "simplereplace.wsf" //nologo /replacequotes /search:"</Project>" /replace:"  <Import Project=^'p2k.props^' /></Project>" /in:"PinMAME32_VC2019.vcxproj" /out:"PinMAME32_VC2019.vcxproj"
@if errorlevel 1 goto manual
@cscript "simplereplace.wsf" //nologo /replacequotes /search:"</Project>" /replace:"  <Import Project=^'p2k.props^' /></Project>" /in:"VPinMAME_VC2019.vcxproj" /out:"VPinMAME_VC2019.vcxproj"
@if errorlevel 1 goto manual
...
@cscript "simplereplace.wsf" //nologo /search:"<PreprocessorDefinitions>" /replace:"<PreprocessorDefinitions>HAS_MEDIAGX=1;" /in:"LibPinMAME_VC2019.vcxproj" /out:"LibPinMAME_VC2019.vcxproj"
@if errorlevel 1 goto manual
@cscript "simplereplace.wsf" //nologo /search:"<PreprocessorDefinitions>" /replace:"<PreprocessorDefinitions>HAS_MEDIAGX=1;" /in:"PinMAME_VC2019.vcxproj" /out:"PinMAME_VC2019.vcxproj"
@if errorlevel 1 goto manual
@cscript "simplereplace.wsf" //nologo /search:"<PreprocessorDefinitions>" /replace:"<PreprocessorDefinitions>HAS_MEDIAGX=1;" /in:"PinMAME32_VC2019.vcxproj" /out:"PinMAME32_VC2019.vcxproj"
@if errorlevel 1 goto manual
@cscript "simplereplace.wsf" //nologo /search:"<PreprocessorDefinitions>" /replace:"<PreprocessorDefinitions>HAS_MEDIAGX=1;" /in:"VPinMAME_VC2019.vcxproj" /out:"VPinMAME_VC2019.vcxproj"
@if errorlevel 1 goto manual
