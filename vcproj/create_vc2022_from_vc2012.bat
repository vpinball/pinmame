...
@if errorlevel 1 goto manual
@cscript "simplereplace.wsf" //nologo /search:"inline=__inline;" /replace:"" /in:"PinMAME_VC2022.vcxproj" /out:"PinMAME_VC2022.vcxproj"
@if errorlevel 1 goto manual
...
@if errorlevel 1 goto manual
@cscript "simplereplace.wsf" //nologo /search:"inline=__inline;" /replace:"" /in:"PinMAME32_VC2022.vcxproj" /out:"PinMAME32_VC2022.vcxproj"
@if errorlevel 1 goto manual
...
@cscript "simplereplace.wsf" //nologo /replacequotes /search:"</Project>" /replace:"  <Import Project=^'p2k.props^' /></Project>" /in:"LibPinMAME_VC2022.vcxproj" /out:"LibPinMAME_VC2022.vcxproj"
@if errorlevel 1 goto manual
@cscript "simplereplace.wsf" //nologo /replacequotes /search:"</Project>" /replace:"  <Import Project=^'p2k.props^' /></Project>" /in:"PinMAME_VC2022.vcxproj" /out:"PinMAME_VC2022.vcxproj"
@if errorlevel 1 goto manual
@cscript "simplereplace.wsf" //nologo /replacequotes /search:"</Project>" /replace:"  <Import Project=^'p2k.props^' /></Project>" /in:"PinMAME32_VC2022.vcxproj" /out:"PinMAME32_VC2022.vcxproj"
@if errorlevel 1 goto manual
@cscript "simplereplace.wsf" //nologo /replacequotes /search:"</Project>" /replace:"  <Import Project=^'p2k.props^' /></Project>" /in:"VPinMAME_VC2022.vcxproj" /out:"VPinMAME_VC2022.vcxproj"
@if errorlevel 1 goto manual
...
@cscript "simplereplace.wsf" //nologo /search:"<PreprocessorDefinitions>" /replace:"<PreprocessorDefinitions>HAS_MEDIAGX=1;" /in:"LibPinMAME_VC2022.vcxproj" /out:"LibPinMAME_VC2022.vcxproj"
@if errorlevel 1 goto manual
@cscript "simplereplace.wsf" //nologo /search:"<PreprocessorDefinitions>" /replace:"<PreprocessorDefinitions>HAS_MEDIAGX=1;" /in:"PinMAME_VC2022.vcxproj" /out:"PinMAME_VC2022.vcxproj"
@if errorlevel 1 goto manual
@cscript "simplereplace.wsf" //nologo /search:"<PreprocessorDefinitions>" /replace:"<PreprocessorDefinitions>HAS_MEDIAGX=1;" /in:"PinMAME32_VC2022.vcxproj" /out:"PinMAME32_VC2022.vcxproj"
@if errorlevel 1 goto manual
@cscript "simplereplace.wsf" //nologo /search:"<PreprocessorDefinitions>" /replace:"<PreprocessorDefinitions>HAS_MEDIAGX=1;" /in:"VPinMAME_VC2022.vcxproj" /out:"VPinMAME_VC2022.vcxproj"
@if errorlevel 1 goto manual
